...
@section('content')
    ...
    <video autoplay muted loop id="bgTopLoop"  style="z-index:2; opacity: 0.1" uk-parallax="blur:200;">
...
<div class="container-fluid tile1  w-100 h-100">
    <div class="content w-100 h-100">
        <div class="row" uk-parallax="blur:5;">
...
<div class="container title pt-0 mt-0 w-100 h-100 px-0 mx-auto movingBackground">
